      ...
      sections={[
        ...
        },
        {
          ...
          paragraphs: [
            ...
            'Jedes Projekt startet mit einer ehrlichen Machbarkeitseinschätzung: Was automatisierbar ist, automatisieren wir. Wo KI keinen Mehrwert bringt, sage ich Ihnen das – bevor Budget fließt.',
          ],
        },
      ]}
    />
