      ...
      sections={[
        {
          ...
          paragraphs: [
            'Gutes Webdesign ist mehr als eine hübsche Oberfläche. Ihre Website muss auf dem Smartphone genauso überzeugen wie auf dem Desktop, in unter zwei Sekunden laden und Besucher ohne Umwege zur Kontaktaufnahme führen. Sie muss auch von Google verstanden werden, sonst findet sie niemand.',
        ...
        },
        {
          ...
          paragraphs: [
            'Der Ablauf ist bewusst schlank und funktioniert vollständig remote deutschlandweit. Auf Wunsch treffe ich Sie persönlich in Lübeck oder Hamburg.',
          ],
          bullets: [
